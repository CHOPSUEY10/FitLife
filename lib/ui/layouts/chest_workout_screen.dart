...
class _ChestWorkoutScreenState extends State<ChestWorkoutScreen>
  ...
  void _onWorkoutFinished() async {
    ...
    final cal = await logic.saveWorkoutRecord(idJenisAktifitas: 'chest_workout', durasiLatihan: totalMin);
    if (!mounted) return;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Kerja bagus! Kamu berhasil menyelesaikan semua latihan Chest Workout.',
