...
class _AbsWorkoutScreenState extends State<AbsWorkoutScreen>
    ...
    if (mounted) {
      setState(() {
        ...
        _progressController = AnimationController(
          vsync: this, 
          duration: Duration(seconds: _exercises.isNotEmpty ? _exercises[0]['duration'] : 30)
        );
  ...
  void _startExercise() {
    ...
    _progressController.duration =
        Duration(seconds: _exercises[_currentIndex]['duration']);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Kerja bagus! Kamu berhasil menyelesaikan semua latihan Abs Workout.',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: _isResting ? _buildRestScreen() : _buildWorkoutScreen(exercise),
      ),
    );
  }
      ...
      children: [
        ...
        ScaleTransition(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              shape: BoxShape.circle,
              border: Border.all(color: const Color(0xFFC6FF00), width: 4),
            ),
        ...
        Text(
          _exercises[_currentIndex + 1]['reps'],
          style: const TextStyle(color: Color(0xFFC6FF00), fontSize: 16),
        ),
      ],
    );
  }
        ...
        Padding(
          ...
          child: ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              valueColor:
              const AlwaysStoppedAnimation<Color>(Color(0xFFC6FF00)),
            ),
          ),
        ),
